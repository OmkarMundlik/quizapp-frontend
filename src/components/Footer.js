      ...
      <div className="container p-4">
        <div className="row">
          <div className="col-md-12">
            ...
            <div>
            <a className="btn btn-primary btn-floating m-1" style={{ backgroundColor: "#0082ca"}} href="https://www.youtube.com/@Spardhaweb" role="button" target="_blank"><i className="fab fa-youtube"></i></a>
              ...
              <a className="btn btn-primary btn-floating m-1" style={{ backgroundColor: "#0082ca" }} href="https://whatsapp.com/channel/0029VacaEMFInlqSAA9ilQ1f" role="button" target="_blank"><i className="fab fa-whatsapp"></i></a>
